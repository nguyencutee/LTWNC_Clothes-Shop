...
const PlaceOrder = () => {
  ...
  useEffect(()=>{
    ...
    else if (parseInt(getTotalCartAmount().replace(/\D/g, "")) === 0){
      navigate('/cart')
    }
  },[token])
  ...
  return (
    <form onSubmit={placeOrder} className='place-order'>
      <div className="place-order-left">
        ...
        <input required name='street' onChange={onChangeHandler} value={data.street} type="text" placeholder='Địa chỉ hiện tại' />
        <div className="multi-fields">
